...
function openNav() {
    document.getElementById("rightSidebar-js-id").style.width = "30%";
    document.getElementById("v3d-container").style.marginRight = "30%";
  }

  /* Set the width of the sidebar to 0 and the left margin of the page content to 0 */
function closeNav() {
    document.getElementById("rightSidebar-js-id").style.width = "0";
    document.getElementById("v3d-container").style.marginRight = "0";
  }
...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__miha configurator v3.gltf'.replace('__URL__', '');
    if (!sceneURL) {
